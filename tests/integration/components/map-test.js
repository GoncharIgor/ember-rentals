...
module('Integration | Component | map', function(hooks) {
  ...
  test('it updates the `src` attribute when the arguments change', async function (assert) {
    ...
    // this.setProperties testing API - passing arbitrary values into our component.
    // "this" here does NOT refer to the component instance,
    // "this" refers to a special test context object, which we have access to inside the render helper
    this.setProperties({
      width: 300,
      height: 200,
      zoom: 12,
